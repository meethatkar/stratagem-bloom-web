...
export const services: ServiceDetail[] = [
  {
    ...
    editorial: {
      ...
      points: [
        { title: "Design & Concept", description: "Event narrative, theme, stage and spatial design aligned to the business objective." },
        { title: "Technical Production", description: "Stage, sound, lighting, LED, content playback and show calling with rehearsed cue sheets." },
        { title: "Delivery & Logistics", description: "Vendor management, permissions, hospitality, crew scheduling and on-site command." },
      ],
    },
    process: [
      { step: "01", title: "Brief & Objective", description: "We define the audience, the message and the commercial outcome the event must serve." },
      { step: "02", title: "Concept & Design", description: "Creative direction, format, content architecture and production design are developed together." },
      { step: "03", title: "Production Planning", description: "Detailed run sheets, technical drawings, vendor contracts and contingency planning." },
      { step: "04", title: "Execution & Review", description: "On-ground delivery with a dedicated show team, followed by a structured debrief." },
    ],
    outcomes: [
      { title: "Clear ownership", description: "One partner accountable for creative, production and logistics." },
      { title: "Protected experience", description: "Rehearsed operations that keep complexity invisible to your audience." },
      { title: "Purposeful formats", description: "Programmes designed around the decisions you want your audience to make." },
    ],
    cta: { heading: "Planning a convention, launch or roadshow?", label: "Request a Quote", href: "/#inquiry" },
  ...
  },
  {
    ...
    editorial: {
      ...
      points: [
        { title: "Narrative Architecture", description: "Positioning, message houses and proof points that hold up to scrutiny." },
        { title: "Media Engagement", description: "Relationships, briefings, press material and distribution to relevant publications." },
        { title: "Stakeholder Programmes", description: "Investor, employee, partner and community communication planned as one system." },
      ],
    },
    process: [
      { step: "01", title: "Audit", description: "We review current coverage, perception, messaging and communication risks." },
      { step: "02", title: "Strategy", description: "Narrative, audience map, channel plan and spokesperson framework." },
      { step: "03", title: "Engagement", description: "Story development, media outreach, press distribution and event-linked publicity." },
      { step: "04", title: "Monitoring", description: "Coverage tracking, sentiment review and continuous message refinement." },
    ],
    outcomes: [
      { title: "Consistent voice", description: "A single corporate narrative across leadership, media and internal channels." },
      { title: "Prepared leadership", description: "Spokespeople briefed and rehearsed before they face an audience." },
      { title: "Relevant visibility", description: "Coverage in the publications and forums your stakeholders actually read." },
    ],
    cta: { heading: "Need a sharper corporate narrative?", label: "Request a Quote", href: "/#inquiry" },
  ...
  },
  {
    ...
    heroAlt: "Embossed brand collateral with copper foil edges and colour swatches on a designer's desk",
    supportingImage: productionImage,
    ...
    editorial: {
      ...
      points: [
        { title: "Identity", description: "Logo, marque, typography, colour and the principles behind each choice." },
        { title: "Applications", description: "Decks, stationery, collateral, signage, environmental and event branding." },
        { title: "Governance", description: "Style guides, asset libraries and templates that keep execution consistent." },
      ],
    },
    process: [
      { step: "01", title: "Discovery", description: "Business positioning, audience and competitive landscape inform the design brief." },
      { step: "02", title: "Direction", description: "Distinct visual territories are explored and narrowed with rationale." },
      { step: "03", title: "System Build", description: "The chosen direction is developed into a complete, documented identity system." },
      { step: "04", title: "Rollout", description: "Templates, asset libraries and training so teams can apply the brand independently." },
    ],
    outcomes: [
      { title: "Recognisability", description: "A distinct visual signature across every touchpoint." },
      { title: "Faster execution", description: "Templates and libraries that reduce turnaround on routine collateral." },
      { title: "Consistent quality", description: "Clear rules that protect the brand across teams and vendors." },
    ],
    cta: { heading: "Building or refreshing a brand identity?", label: "Request a Quote", href: "/#inquiry" },
  ...
  },
  {
    ...
    editorial: {
      ...
      points: [
        { title: "Strategy", description: "Audience definition, channel mix, budget allocation and measurement framework." },
        { title: "Creative", description: "Campaign concepts adapted across digital, social, OOH and print formats." },
        { title: "Performance", description: "Structured testing, optimisation cycles and transparent reporting." },
      ],
    },
    process: [
      { step: "01", title: "Objective", description: "We agree the commercial metric the campaign is accountable for." },
      { step: "02", title: "Plan", description: "Audience, channel mix, creative approach and measurement are defined upfront." },
      { step: "03", title: "Launch", description: "Assets are produced, trafficked and released across selected channels." },
      { step: "04", title: "Optimise", description: "Continuous review of creative, placement and spend against performance." },
    ],
    outcomes: [
      { title: "Coherent presence", description: "One idea expressed consistently across paid, owned and physical media." },
      { title: "Measured spend", description: "Budget allocated against tracked performance rather than assumption." },
      { title: "Faster learning", description: "Structured testing that improves creative and targeting over time." },
    ],
    cta: { heading: "Ready to take a campaign to market?", label: "Request a Quote", href: "/#inquiry" },
  ...
  },
  {
    ...
    editorial: {
      ...
      points: [
        { title: "Market Entry", description: "Segment prioritisation, proposition definition and route-to-market design." },
        { title: "Commercial Engine", description: "Business development structures, partner programmes and pipeline discipline." },
        { title: "Operating Model", description: "Roles, processes and governance that let growth scale without breaking." },
      ],
    },
    process: [
      { step: "01", title: "Diagnostic", description: "A structured review of proposition, market position, pipeline and capacity." },
      { step: "02", title: "Framing", description: "Options are developed with the trade-offs and assumptions made explicit." },
      { step: "03", title: "Plan", description: "A sequenced roadmap with owners, milestones and commercial checkpoints." },
      { step: "04", title: "Support", description: "Hands-on support through execution, with periodic review and course correction." },
    ],
    outcomes: [
      { title: "Clear priorities", description: "A defined sequence of moves rather than a list of possibilities." },
      { title: "Executable plans", description: "Recommendations sized to your actual team and budget." },
      { title: "Aligned leadership", description: "Shared understanding of the plan across decision makers." },
    ],
    cta: { heading: "Preparing for the next stage of growth?", label: "Request a Quote", href: "/#inquiry" },
